...
You have just been invoked because the user suspects your latest response violated instructions from the loaded context files.
...
Ask for confirmation before proceeding with the correction.
